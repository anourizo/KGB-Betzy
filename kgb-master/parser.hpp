...
COUT << " \033[1;31merror:\033[0m"<< " \033[1;31merror: radiation treat-ment using hiclass interface is not supported!\033[0m" << endl;
#ifdef LATFIELD2_HPP
parallel.abortForce();
#endif
#endif
...
#endif
#if defined(HAVE_HICLASS)
COUT << " \033[1;31merror:\033[0m"<< " \033[1;31merror: fluid treat-ment using hiclass interface is not tested!\033[0m" << endl;
#ifdef LATFIELD2_HPP
parallel.abortForce();
#endif
#endif
