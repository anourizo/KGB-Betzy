...
enum spatial_curvature {spatial_flat, spatial_open, spatial_closed};
...
enum gravity_model {propto_omega, propto_scale,
    ...
    k_essence_scherrer, k_essence_power
...
struct background
{
  ...
  int index_bg_cs2_prime_smg; /**< derivative of speed of sound for scalar perturbations wrt tau */
